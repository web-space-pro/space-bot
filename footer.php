...
if (function_exists('get_field')) {
    ...
    $title = get_field('o_title_form', 'options');
    $subtitle = get_field('o_form_subtitle', 'options');
    $copyright = get_field('o_copyright', 'options');
}
?>
<footer id="callback" class="footer">
                ...
                <div class="callback">
                    <div class="callback__wrap">
                        <div class="callback__title">
                            <div class="callback__title--content">
                                <?php if(!empty($title)) : ?>
                        ...
                        <div class="callback__contacts">
                            <div class="callback__contacts--wrap">
                                <div class="callback__form">
                                        <?= do_shortcode('[contact-form-7 id="252b5e4"]') ?>
                                </div>
                                ...
                                <div class="callback__contact">
                                    ...
                                    <div class="callback__contact--links">
                                        <?php if(!empty($wts)) : ?>
